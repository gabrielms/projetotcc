class InferenceMachine
	...
	AGE_WEIGHT_IN_CALCULATION = 0.05
	STATURE_WEIGHT_IN_CALCULATION = 0.05
	WEIGHT_WEIGHT_IN_CALCULATION = 0.05
	SEX_WEIGHT_IN_CALCULATION = 0.4
	OBJECTIVE_WEIGHT_IN_CALCULATION = 0.3
	DISEASES_WEIGHT_IN_CALCULATION = 0.05
	HOW_OFTEN_PRATICE_WEIGHT_IN_CALCULATION = 0.05
	HOW_LONG_IS_ON_GYM_WEIGHT_IN_CALCULATION = 0.05
