...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { muscle_group_id: @workout.muscle_group_id, name: @workout.name }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { muscle_group_id: @workout.muscle_group_id, name: @workout.name }
    assert_redirected_to workout_path(assigns(:workout))
  end
