...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { cref: @coach.cref, name: @coach.name, phone: @coach.phone, user_id: @coach.user_id }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { cref: @coach.cref, name: @coach.name, phone: @coach.phone, user_id: @coach.user_id }
    assert_redirected_to coach_path(assigns(:coach))
  end
